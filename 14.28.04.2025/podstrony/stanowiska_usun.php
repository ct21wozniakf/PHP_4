<h1>Usuwanie w tabeli <em>stanowiska</em></h1>
<?php
...
if($_SERVER['REQUEST_METHOD'] === 'POST') {
    ...
    $query = "DELETE FROM `stanowiska` WHERE `Id_stanowisko` = '".$_POST['id_stanowisko']."'";
...
<form action="tungtungtungsahur.php?podstrona=stanowiska_usun" method="post">

    <h4 style="color: red;">Czy chcesz usunąć dane?</h4>

    <table>
        <tr>
            <td><label for="id_stanowisko">Id_dzial</label></td>
